...
ALLOWED_HOSTS = ['learnbudsgvr.pythonanywhere.com']
# ALLOWED_HOSTS = []
...
EMAIL_HOST_USER = 'updates.learnbuds@gmail.com'  # Your email
EMAIL_HOST_PASSWORD = 'zqpk kbcw rkwt dase'  # Your email app password
DEFAULT_FROM_EMAIL = 'updates.learnbuds@gmail.com'  # Default from email
